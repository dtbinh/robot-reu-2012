...
###
### This module performs all image processing on the incoming RGB images.
### Provides functions that initialize the images, threshold the images, find
### contours and biggest regions in the images, process selected sections for
### thresholding, set a target coordinate, and display an information box in the
### RGB image window.
###
################################################################################
