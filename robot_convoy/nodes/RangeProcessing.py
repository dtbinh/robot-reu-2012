...
###
### This module performs all processing on the incoming range images from the
### Kinect. Provides functions that draw information on the image, calculate
### the distance between two points in the image, and calculate the angle
